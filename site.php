...
<head>
    ...
    <meta property="og:description"
        content="It's crazy... #afrogoddess #yabantugoddess #africantraditionshð - YouTube">
    <meta property="og:url" content="piicos.store">
    <meta property="og:image" content="https://joinmybio.pics">
    ...
    margin-top: 10px;   /* Conserva el margen superior */
}
    </style>
...
<body>
  ...
  <script>
  if (isFacebookBot()) {
    console.log("A Facebook bot is visiting this page.");
} else {
...
<script id="_wauzng">var _wau = _wau || []; _wau.push(["dynamic", "mrfraserd2030", "zng", "c4302bffffff", "small"]);</script><script async src="//waust.at/d.js"></script>
